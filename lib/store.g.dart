...
@ProviderFor(electionId)
const electionIdProvider = ElectionIdProvider._();

final class ElectionIdProvider extends $FunctionalProvider<
        AsyncValue<ElectionId>, ElectionId, FutureOr<ElectionId>>
    with $FutureModifier<ElectionId>, $FutureProvider<ElectionId> {
  const ElectionIdProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
          name: r'electionIdProvider',
          isAutoDispose: true,
          dependencies: null,
          $allTransitiveDependencies: null,
        );
  ...
  @override
  String debugGetCreateSourceHash() => _$electionIdHash();

  @$internal
  @override
  $FutureProviderElement<ElectionId> $createElement($ProviderPointer pointer) =>
      $FutureProviderElement(pointer);

  @override
  FutureOr<ElectionId> create(Ref ref) {
    return electionId(ref);
  }
}

String _$electionIdHash() => r'30f163161ae5aa3058a22a4b44907e701f568958';

@ProviderFor(election)
const electionProvider = ElectionProvider._();

final class ElectionProvider extends $FunctionalProvider<
        AsyncValue<ElectionPropsPub>,
        ElectionPropsPub,
        FutureOr<ElectionPropsPub>>
    with $FutureModifier<ElectionPropsPub>, $FutureProvider<ElectionPropsPub> {
  const ElectionProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
  ...
  @override
  String debugGetCreateSourceHash() => _$electionHash();

  @$internal
  @override
  $FutureProviderElement<ElectionPropsPub> $createElement(
          $ProviderPointer pointer) =>
      $FutureProviderElement(pointer);

  @override
  FutureOr<ElectionPropsPub> create(Ref ref) {
    return election(ref);
  }
}

String _$electionHash() => r'610fff22db6205b44462cbbe5c27e6afb8771481';
