...
String _$synchronizerNotifierHash() =>
    r'049414ae8378414353563749d26326461231fee4';
...
final class MigrationNotifierProvider
    extends $AsyncNotifierProvider<MigrationNotifier, MigrationStatus?> {
  /// The migration notifier — polls stepMigration() periodically when active.
...
String _$migrationNotifierHash() => r'0ed3cba4bad29d4ab7f1e735a58279cddeb08aaa';

/// The migration notifier — polls stepMigration() periodically when active.

abstract class _$MigrationNotifier extends $AsyncNotifier<MigrationStatus?> {
  FutureOr<MigrationStatus?> build();
  @$mustCallSuper
  @override
  void runBuild() {
    final created = build();
    final ref =
        this.ref as $Ref<AsyncValue<MigrationStatus?>, MigrationStatus?>;
    final element = ref.element as $ClassProviderElement<
        AnyNotifier<AsyncValue<MigrationStatus?>, MigrationStatus?>,
        AsyncValue<MigrationStatus?>,
        Object?,
        Object?>;
    element.handleValue(ref, created);
  }
