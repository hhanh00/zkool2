      ...
      _sub = stream.listen(
        (status) {
          ...
          if (status.nextAction.startsWith('Waiting')) {
            ...
            final m = RegExp(r'Waiting (\d+)s').firstMatch(status.nextAction);
            if (m != null) {
              _hasCountdown = true;
        ...
        onError: (e) {
          if (!mounted) return;
          final message = e is AnyhowException ? e.message : e.toString();
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        showDialog(
          ...
          builder: (_) => AlertDialog(
            ...
            content: const Text("All notes have been migrated to Ironwood."),
            actions: [
              TextButton(
                onPressed: () {
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("Orchard to Ironwood Migration", style: Theme.of(context).textTheme.headlineSmall),
                            const Gap(12),
                            const Text(
                            ...
                            const Gap(16),
                            // Speed selector
                            Text("Migration Speed", style: Theme.of(context).textTheme.titleMedium),
                            const Gap(8),
                            Row(
                              children: [
                                Expanded(
                                  child: Slider(
                                    ...
                                    onChanged: (v) => setState(() => _speedIndex = v),
                                  ),
                                ),
                                SizedBox(
                                  width: 80,
                            ...
                            Card(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Icon(Icons.shield_outlined, size: 20, color: Theme.of(context).colorScheme.onSurfaceVariant),
                                    const Gap(8),
                                    Expanded(
                                      child: Text(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      ...
                      style: tt.bodyMedium?.copyWith(color: t.colorScheme.onSurfaceVariant),
                    ),
                  ],
                ),
              ),
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(phase == 'migrating' ? "Migration Progress" : "Orchard Notes", style: tt.titleMedium),
                      const Gap(8),
                      Text(
                        phase == 'migrating'
