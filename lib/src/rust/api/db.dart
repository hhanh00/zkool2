...
Future<List<DbAccountPreview>> listDbAccounts({required String dbFilepath}) => RustLib.instance.api.crateApiDbListDbAccounts(dbFilepath: dbFilepath);
...
class DbAccountPreview {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is DbAccountPreview && runtimeType == other.runtimeType && id == other.id && name == other.name;
}
