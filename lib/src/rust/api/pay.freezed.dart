...
mixin _$PcztPackage {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.ironwoodIndices, ironwoodIndices) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(ironwoodIndices),
      canSign,
      canBroadcast,
      price,
      category,
  ...
  @override
  String toString() {
    return 'PcztPackage(pczt: $pczt, nSpends: $nSpends, saplingIndices: $saplingIndices, orchardIndices: $orchardIndices, ironwoodIndices: $ironwoodIndices, canSign: $canSign, canBroadcast: $canBroadcast, price: $price, category: $category, isIssuance: $isIssuance)';
  }
}
    ...
    return _then(_self.copyWith(
      ...
      orchardIndices: null == orchardIndices
          ...
          : orchardIndices // ignore: cast_nullable_to_non_nullable
              as Uint64List,
      ironwoodIndices: null == ironwoodIndices
          ? _self.ironwoodIndices
          : ironwoodIndices // ignore: cast_nullable_to_non_nullable
              as Uint64List,
...
extension PcztPackagePatterns on PcztPackage {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Uint8List pczt, UsizeArray4 nSpends, Uint64List saplingIndices, Uint64List orchardIndices, Uint64List ironwoodIndices, bool canSign,
            bool canBroadcast, double? price, int? category, bool isIssuance)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _PcztPackage() when $default != null:
        return $default(_that.pczt, _that.nSpends, _that.saplingIndices, _that.orchardIndices, _that.ironwoodIndices, _that.canSign, _that.canBroadcast,
            _that.price, _that.category, _that.isIssuance);
      case _:
        return orElse();
    }
  }
