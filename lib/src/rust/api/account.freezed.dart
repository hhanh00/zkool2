  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isUserMemo, isUserMemo) || other.isUserMemo == isUserMemo));
  }

  @override
  int get hashCode => Object.hash(runtimeType, id, idTx, idNote, pool, height, vout, time, const DeepCollectionEquality().hash(memoBytes), memo, isUserMemo);
...
abstract mixin class $MemoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int idTx, int? idNote, int pool, int height, int vout, int time, Uint8List memoBytes, String? memo, bool isUserMemo});
}
...
extension MemoPatterns on Memo {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, int idTx, int? idNote, int pool, int height, int vout, int time, Uint8List memoBytes, String? memo, bool isUserMemo)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Memo() when $default != null:
        return $default(_that.id, _that.idTx, _that.idNote, _that.pool, _that.height, _that.vout, _that.time, _that.memoBytes, _that.memo, _that.isUserMemo);
      case _:
        return orElse();
    }
  }
...
mixin _$Tx {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, const DeepCollectionEquality().hash(txid), height, time, value, tpe, category, zsaValue, assetId,
      assetDisplay, price, memo, isUserMemo, contactName);
...
extension TxPatterns on Tx {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, Uint8List txid, int height, int time, PlatformInt64 value, int? tpe, String? category, PlatformInt64 zsaValue, int? assetId,
            String assetDisplay, double? price, String? memo, bool isUserMemo, String? contactName)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Tx() when $default != null:
        return $default(_that.id, _that.txid, _that.height, _that.time, _that.value, _that.tpe, _that.category, _that.zsaValue, _that.assetId,
            _that.assetDisplay, _that.price, _that.memo, _that.isUserMemo, _that.contactName);
      case _:
        return orElse();
    }
  }
