...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiTransactionFillMissingTxPrices({required String api, required String currency, required Coin c});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  PcztPackage sse_decode_pczt_package(SseDeserializer deserializer) {
    ...
    var var_orchardSplitSpendIndices = sse_decode_list_prim_usize_strict(deserializer);
  ...
  TAddressTxCount sse_decode_t_address_tx_count(SseDeserializer deserializer) {
    ...
    var var_time = sse_decode_u_32(deserializer);
    return TAddressTxCount(address: var_address, scope: var_scope, dindex: var_dindex, amount: var_amount, txCount: var_txCount, time: var_time);
  }
  ...
  TxMemo sse_decode_tx_memo(SseDeserializer deserializer) {
    ...
    var var_pool = sse_decode_u_8(deserializer);
    var var_memo = sse_decode_opt_String(deserializer);
    return TxMemo(note: var_note, output: var_output, pool: var_pool, memo: var_memo);
  }
  ...
  TxOutput sse_decode_tx_output(SseDeserializer deserializer) {
    ...
    var var_value = sse_decode_u_64(deserializer);
    var var_address = sse_decode_String(deserializer);
    return TxOutput(id: var_id, pool: var_pool, height: var_height, value: var_value, address: var_address);
  }
  ...
  void sse_encode_pczt_package(PcztPackage self, SseSerializer serializer) {
    ...
    sse_encode_list_prim_usize_strict(self.orchardSplitSpendIndices, serializer);
