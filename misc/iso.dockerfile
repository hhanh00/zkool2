...
# Copy locale conf files
COPY locale/locale.conf p/airootfs/etc
COPY locale/locale.gen p/airootfs/etc
COPY locale/locale-gen.hook p/airootfs/etc/pacman.d/hooks/
