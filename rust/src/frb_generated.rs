...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1981885074;
...
fn wire__crate__api__account__dummy_export_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_a = <crate::api::pay::SigningEvent>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::account::dummy_export(api_a);
                    })?;
                    Ok(output_ok)
                })())
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        29 => wire__crate__api__account__dummy_export_impl(port, ptr, rust_vec_len, data_len),
        ...
        111 => wire__crate__api__account__sign_ledger_transaction_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
