...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1047175686;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        8 => wire__crate__api__account__put_account_transparent_secret_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        3 => wire__crate__api__account__new_seed_impl(ptr, rust_vec_len, data_len),
        4 => wire__crate__api__account__put_account_metadata_impl(ptr, rust_vec_len, data_len),
        5 => {
        ...
        7 => wire__crate__api__account__put_account_seed_impl(ptr, rust_vec_len, data_len),
        9 => {
        ...
        12 => wire__crate__api__account__set_db_filepath_impl(ptr, rust_vec_len, data_len),
