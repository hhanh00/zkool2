...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -2096335184;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        39 => wire__crate__api__network__init_datadir_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__frost__init_dkg_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__frost__init_sign_impl(port, ptr, rust_vec_len, data_len),
        42 => {
