...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        29 => wire__crate__api__account__reset_sync_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__sync__rewind_sync_impl(port, ptr, rust_vec_len, data_len),
