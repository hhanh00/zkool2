...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -981323295;
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok =
                        crate::api::account::put_account_sapling_secret(api_id, &api_esk)?;
                    Ok(output_ok)
                })(),
            )
        },
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok =
                        crate::api::account::put_account_sapling_viewing(api_id, &api_evk)?;
                    Ok(output_ok)
                })(),
            )
        },
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok =
                        crate::api::account::put_account_seed(api_id, &api_phrase, api_aindex)?;
                    Ok(output_ok)
                })(),
            )
        },
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok =
                            crate::api::account::put_account_transparent_secret(api_id, &api_sk)?;
                        Ok(output_ok)
                    })(),
                )
            }
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok =
                        crate::api::account::put_account_unified_viewing(api_id, &api_uvk)?;
                    Ok(output_ok)
                })(),
            )
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__account__init_app_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__account__list_accounts_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__db__open_database_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__account__put_account_transparent_secret_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__account__receivers_default_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__key__is_valid_key_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__api__account__new_account_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__api__account__new_seed_impl(ptr, rust_vec_len, data_len),
        10 => wire__crate__api__account__put_account_metadata_impl(ptr, rust_vec_len, data_len),
        11 => {
        ...
        13 => wire__crate__api__account__put_account_seed_impl(ptr, rust_vec_len, data_len),
        15 => {
            wire__crate__api__account__put_account_unified_viewing_impl(ptr, rust_vec_len, data_len)
        }
        17 => wire__crate__api__account__receivers_from_ua_impl(ptr, rust_vec_len, data_len),
        19 => wire__crate__api__account__ua_from_ufvk_impl(ptr, rust_vec_len, data_len),
        20 => wire__crate__api__account__update_account_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
