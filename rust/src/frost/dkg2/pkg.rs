...
use super::protocol::{BinaryRW, FrostMap, PublicData, SecretData};
use crate::tiu;
...
pub fn build_part1(
    ...
    DKGRound1Secret,
    Either<DKGRound1Public, FrostMap<DKGRound1Public>>,
)> {
...
pub fn build_part2(
    ...
    DKGRound2Secret,
    Either<DKGRound2Public, FrostMap<DKGRound2Public>>,
)> {
...
pub fn build_part3(
    ...
    DKGRound3Secret,
    Either<DKGRound3Public, FrostMap<DKGRound3Public>>,
)> {
    ...
    let (s, p) = reddsa::frost::redpallas::keys::dkg::part3(
        &secret_package,
        &round1_packages,
        &round2_packages,
    )?;
