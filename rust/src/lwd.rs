...
pub struct CompactIssuance {
    /// \[32\] BLAKE2b-256 hash of the asset description string
    #[prost(bytes = "vec", tag = "1")]
    pub asset_desc_hash: ::prost::alloc::vec::Vec<u8>,
    /// Whether this action finalizes the asset
    #[prost(bool, tag = "2")]
    pub finalize: bool,
    /// \[33\] Issuer Validating Key (algorithm byte + x-only pubkey)
    #[prost(bytes = "vec", tag = "3")]
